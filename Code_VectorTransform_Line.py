...
transform_line_sr = osr.CoordinateTransformation(vect_spatial_reference, rast_sr_object)
...
out_vect_layer = out_data_source.CreateLayer('transform_line', rast_sr_object, ogr.wkbLineString)
...
for in_feat in vect_layer:
    ...
    geom.Transform(transform_line_sr)
